...
- **Notification "demande d'ami reçue"** : push + badge, même mécanisme que les autres notifications de l'app (voir `architecture-technique.md` pour l'infra de notifications) — pas de canal dédié spécifique à ce domaine.
