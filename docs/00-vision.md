...
| `account.docs.md`, `dog.docs.md`, `friend.docs.md`, `walk.docs.md` | Specs fonctionnelles par domaine — vivent dans le repo, co-localisées avec le code (`src/domain/<domaine>/`) |
